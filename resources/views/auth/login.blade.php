                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="user">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" id="inlineFormInputGroup" placeholder="name@example.com" required autocomplete="email" autofocus>
                        ...
                        <div class="user">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input name="password" type="password" class="form-control @error('password') is-invalid @enderror" id="inlineFormInputGroup" placeholder="***************" required autocomplete="current-password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="remember" value="" id="invalidCheck2" {{ old('remember') ? 'checked' : '' }}>
